...
Amazon Kindles store all markings - both from ebooks purchased with Amazon and documents brought on the kindle in other ways - in the file `/documents/My Clippings.txt`.
